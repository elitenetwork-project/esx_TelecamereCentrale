...
Config.HideRadar = true -- true= HUD visibile 
Config.AnimTime = 60 -- Animazione per l'hacking. 60 = 1 minuto / 60 secondi!

Config.Locale = 'it'
Config.pNotify = true -- Abilitalo solo se hai pNotify (https://github.com/Nick78111/pNotify)
Config.Hacking = true -- Abilita solo se hai mhacking (https://github.com/GHMatti/FiveM-Scripts/tree/master/mhacking)


-- Luogo: nell'armeria della polizia
Config.Zones = {
	Cameras = {
...
-- Keep these the same
-- Luogo: dietro il banco della polizia nella stazione di polizia
...
-- Luogo: giù al caveau della banca
Config.HackingBank = {
	HackingBank = {
...
-- Luogo: giù al caveau della banca
Config.Hackingnuovetelecamere = {
	Hackingnuovetelecamere = {
		Pos   = {x = 264.87, y = 219.93, z = 100.68},
		Size  = {x = 1.7, y = 1.7, z = 0.5},
		Color = {r = 26, g = 55, b = 186},
		Type = 27,
...
Config.UnHacknuovetelecamere = {
	UnHacknuovetelecamere = {
		Pos   = {x = 264.87, y = 219.93, z = 100.68},
		Size  = {x = 1.7, y = 1.7, z = 0.5},
		Color = {r = 26, g = 55, b = 186},
		Type = 27,
...
-- Telecamere. 
-- Puoi aggiungere più videocamere per altre banche, appartamenti, case, edifici ecc. 
-- (Ricorda il "," dopo ogni riga, ma non sull'ultima riga)
Config.Locations = {
	{
	...
	policeCamLabel = {label = _U('police_station')},
		policeCameras = {
		 ...
		 {
        {
        nuovetelecamere = {label = _U('nuove_telecamere')},
        newtelecam = {
        {label = _U('nuovacam'), x= 0.0,y=0.0,z=0.0,r = {x=0.0,y=0.0,z=0.0},canrotate = true }
        }
	}
}
